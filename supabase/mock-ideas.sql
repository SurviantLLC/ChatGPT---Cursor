-- This script will add 30 mock startup ideas to your Supabase database
-- The script will automatically use the first user ID from your auth.users table
...
-- Insert mock ideas
INSERT INTO ideas (title, description, tags, author_id, created_at)
VALUES
  (
    'EcoTrack',
    ...
    ARRAY['sustainability', 'climate-tech', 'mobile-app'],
    user_id,
    NOW() - INTERVAL '1 day'
  ),
  (
    ...
    ARRAY['mental-health', 'wellness', 'ai'],
    user_id,
    NOW() - INTERVAL '2 days'
  ),
  (
    ...
    ARRAY['food-tech', 'subscription', 'sustainability'],
    user_id,
    NOW() - INTERVAL '3 days'
  ),
  (
  ...
  (
    ...
    ARRAY['eldercare', 'social', 'health-tech'],
    user_id,
    NOW() - INTERVAL '5 days'
  ),
  (
    ...
    ARRAY['education', 'community', 'sharing-economy'],
    user_id,
    NOW() - INTERVAL '6 days'
  ),
  (
    ...
    ARRAY['health-tech', 'nutrition', 'mobile-app'],
    user_id,
    NOW() - INTERVAL '7 days'
  ),
  (
    ...
    ARRAY['legal-tech', 'housing', 'consumer-rights'],
    user_id,
    NOW() - INTERVAL '8 days'
  ),
  (
    ...
    ARRAY['smart-home', 'sustainability', 'hardware'],
    user_id,
    NOW() - INTERVAL '9 days'
  ),
  (
    ...
    ARRAY['education', 'productivity', 'microlearning'],
    user_id,
  ...
  (
    ...
    ARRAY['pets', 'sharing-economy', 'community'],
    user_id,
  ...
  (
    ...
    ARRAY['smart-home', 'sustainability', 'iot'],
    user_id,
  ...
  (
    ...
    ARRAY['creator-economy', 'crypto', 'social-media'],
    user_id,
  ...
  (
    ...
    ARRAY['food-tech', 'sustainability', 'smart-home'],
    user_id,
  ...
  (
    ...
    ARRAY['travel', 'ai', 'personalization'],
    user_id,
  ...
  (
    ...
    ARRAY['e-commerce', 'sustainability', 'consumer-tech'],
    user_id,
  ...
  (
    ...
    ARRAY['freelance', 'fintech', 'productivity'],
    user_id,
  ...
  (
    ...
    ARRAY['cleantech', 'energy', 'community'],
    user_id,
  ...
  (
    ...
    ARRAY['fintech', 'education', 'family'],
    user_id,
  ...
  (
    ...
    ARRAY['accessibility', 'b2b', 'consulting'],
    user_id,
  ...
  (
    ...
    ARRAY['food-tech', 'ai', 'health-tech'],
    user_id,
  ...
  (
    ...
    ARRAY['remote-work', 'productivity', 'team-management'],
    user_id,
  ...
  (
    ...
    ARRAY['fashion', 'sustainability', 'circular-economy'],
    user_id,
  ...
  (
    ...
    ARRAY['health-tech', 'coaching', 'habit-formation'],
    user_id,
  ...
  (
    ...
    ARRAY['travel', 'local-experiences', 'marketplace'],
    user_id,
  ...
  (
    ...
    ARRAY['marketplace', 'craftsmanship', 'e-commerce'],
    user_id,
  ...
  (
    ...
    ARRAY['sharing-economy', 'p2p', 'rental'],
    user_id,
  ...
  (
    ...
    ARRAY['home-improvement', 'ai', 'consumer-service'],
    user_id,
  ...
  (
    ...
    ARRAY['education', 'language-learning', 'cultural-exchange'],
    user_id,
    NOW() - INTERVAL '30 days'
  );

-- Add mock interactions (optional)
-- This will add some random interactions to make the data more realistic
-- Uncomment if you want to add interactions as well

/*
-- Create some mock interactions for the ideas
INSERT INTO interactions (user_id, idea_id, swipe, rating, created_at)
SELECT
  user_id,
  id AS idea_id,
  CASE WHEN random() > 0.3 THEN TRUE ELSE FALSE END AS swipe,
  CASE WHEN random() > 0.5 THEN floor(random() * 10)::int + 1 ELSE NULL END AS rating,
